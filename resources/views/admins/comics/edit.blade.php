...
<div class="container">
    ...
    <form action="{{route('comics.update', $lightsaber)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" id="name" aria-describedby="helpId" placeholder="Acolyte Eco Battle staff" value="{{$comics->name}}">
            <small id="nameHelper" class="form-text text-muted">Type the name here</small>
        </div>

        <div class="mb-3">
            <label for="price" class="form-label">Price</label>
            <input type="number" step="0.01" class="form-control" name="price" id="price" aria-describedby="helpId" placeholder="99.99" value="{{$comics->price}}">
        ...
        <div class="d-flex gap-3">
            <div>
                <img width="200" src="{{asset('storage/' . $comics->thumb)}}" alt="">
            </div>
            <div class="mb-3">
